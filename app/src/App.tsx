      ...
      <LayoutProvider>
        ...
        <React.Suspense fallback={<div className="pt-20 text-center text-gray-400">Cargando…</div>}>
          <Routes>
            ...
            <Route path="/transporte" element={<StubPage title="2. Transporte" description="Próximamente — transporte a 2ª mayor y 3ª menor" />} />
            <Route path="/compas-tonalidad" element={<StubPage title="3. Compás y Tonalidad" description="Próximamente — identificar compás y tonalidad" />} />
            <Route path="/intervalos" element={<IntervalsPage />} />
            <Route path="/completar-compas" element={<StubPage title="5. Completar compás" description="Próximamente — completar compases con figuras" />} />
            <Route path="/escalas" element={<ScalesPage />} />
            <Route path="/armadura" element={<KeySignaturesPage />} />
            <Route path="/notas-extranyas" element={<StubPage title="8. Notas extrañas" description="Próximamente — identificar notas de adorno" />} />
