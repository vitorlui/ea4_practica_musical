...
const COMPLETAR_THEORY: TheorySection[] = [
  {
    id: "def",
    steps: [
      { title: "Valores de las figuras (en negras)", body: "Redonda = 4, blanca = 2, negra = 1, corchea = 0.5, semicorchea = 0.25. El puntillo añade la mitad del valor de la figura: negra con puntillo = 1.5, blanca con puntillo = 3." },
      { title: "Proceso para completar", body: "1) Lee el compás (numerador = total de tiempos, denominador = figura de referencia). 2) Convierte todas las figuras existentes a la misma unidad. 3) Suma los valores. 4) Calcula lo que falta. 5) Escribe la figura o silencio equivalente." },
