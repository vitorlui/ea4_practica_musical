...
const ENARMONIA_THEORY: TheorySection[] = [
  {
    ...
    steps: [
      ...
      { title: "Sin distancia entre notas enarmónicas", body: "La distancia entre Do# y Reb es 0 semitonos: suenan exactamente igual. Solo cambia la notación escrita." },
      { title: "Pares enarmónicos más frecuentes", body: "Do#/Reb, Re#/Mib, Fa#/Solb, Sol#/Lab, La#/Sib. Además: Si/Dob y Mi/Fab (menos frecuentes)." },
