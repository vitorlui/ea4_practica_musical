...
const NOTAS_THEORY: TheorySection[] = [
  {
    ...
    steps: [
      ...
      { title: "Nota de paso (NP)", body: "Une dos notas del acorde (o notas estructurales) por movimiento de grado conjunto. Siempre está en parte débil del tiempo. No se repite: va de una nota estructural a otra diferente. Ejemplo: Do-Re-Mi, donde Re es NP entre Do y Mi del acorde." },
      { title: "Bordadura (B)", body: "Sale de una nota del acorde, sube o baja un grado, y vuelve a la misma nota. La primera y la tercera nota son iguales. Siempre en parte débil. Puede ser bordadura superior (un grado arriba) o inferior (un grado abajo). Ejemplo: Mi-Fa-Mi, donde Fa es B superior." },
      { title: "Apoyatura (A)", body: "Aparece en parte fuerte o acentuada del tiempo. No pertenece al acorde. Resuelve por grado conjunto hacia una nota real del acorde. Genera tensión que se resuelve inmediatamente. Ejemplo: Fa en tiempo fuerte → resuelve en Mi (nota del acorde)." },
