...
const SEMITONO_THEORY: TheorySection[] = [
  {
    ...
    steps: [
      ...
      {
        title: "Semitono diatónico",
        body: "Las dos notas tienen nombres distintos: Mi→Fa, Si→Do, La→Sib, Do#→Re. Se mueve a una nota diferente del alfabeto musical (aunque una tenga alteración). Va de una nota a la nota siguiente con nombre diferente.",
        staffExample: {
          notes: [
            { keys: ["e/4"], duration: "h" },
            { keys: ["f/4"], duration: "h" },
          ...
          timeSignature: "",
          caption: "Mi → Fa: semitono diatónico (nombres distintos: E y F)",
        },
      },
      {
        title: "Semitono cromático",
        body: "Las dos notas tienen el mismo nombre pero distinto accidental: Do→Do#, Re→Reb, Sol→Sol#. Solo cambia el accidental (sostenido, bemol, becuadro); el nombre de la nota es el mismo.",
        staffExample: {
          notes: [
            { keys: ["c/4"], duration: "h" },
            { keys: ["c/4"], accidentals: ["#"], duration: "h" },
          ],
          timeSignature: "",
          caption: "Do → Do#: semitono cromático (mismo nombre, distinto accidental)",
        },
      },
      {
        title: "Regla para identificar",
        body: "¿Tienen el mismo nombre de nota? SÍ → cromático. NO → diatónico. Ejemplo: Fa#→Sol (F≠G) = diatónico. Sol→Sol# (G=G) = cromático.",
        highlight: true,
        staffExample: {
          notes: [
            { keys: ["b/3"], duration: "h" },
          ...
          timeSignature: "",
          caption: "Si → Do: diatónico (B ≠ C, nombres distintos)",
        },
      },
  ...
  return (
    ...
    >
      <MCExerciseCard
        ...
        stimulus={exercise.staffNotes ? undefined : (exercise.stimulus || undefined)}
